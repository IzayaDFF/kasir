...
public class Barang extends javax.swing.JFrame {
    ...
    private void simpan(){
     try {
            String sql="insert into barang (Kode_Barang,Nama_Barang,Harga) value (?,?,?)";
            pst=koneksi.prepareStatement(sql);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
         ...
         String sql="update barang set Nama_Barang='"+value1+"' ,Harga='"+value5+"' where Kode_Barang='"+value2+"'";
         pst=koneksi.prepareStatement(sql);
         pst.execute();
